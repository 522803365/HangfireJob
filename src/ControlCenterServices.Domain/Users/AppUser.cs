...
namespace ControlCenterServices.Domain.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ControlCenterServicesDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ControlCenterServicesEfCoreEntityExtensionMappings to extend the IdentityUser entity
